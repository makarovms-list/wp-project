...
<div class="content knowledge-center single-post blog side-block-page">
              ...
              <div class="wpb_wrapper">
                ...
                <div class="vc_row wpb-mobile-paddign-top-0 wpb_row vc_row-fluid">
                  ...
                  <div class="wpb_column vc_column_container vc_col-sm-4 wpb-mobile-margin-top-32 ">
                    <div class="vc_column-inner">
                      <div class="wpb_wrapper">
                        <?php if (isset($right_side_content['side_callout']['title']) && $right_side_content['side_callout']['title'] != ''): ?>
                            <?php print petrosoft_get_template('template-parts/knowledge-center/post-side-callout',$right_side_content['side_callout']) ?>
                        <?php endif; ?>
                        <?php if (isset($right_side_content['content']) && $right_side_content['content'] != ''): ?>
                          <div class="right-side-content">
                            <?php print $right_side_content['content']; ?>
                          </div>
                        <?php endif; ?>
                ...
                <?php get_template_part('template-parts/knowledge-center/blog-related-posts'); ?>
              </div>
            </div>
          </div>
        </div>
