...
<div class="content knowledge-center single-broshures-flyers single-post side-block-page">
              ...
              <div class="wpb_wrapper">
                ...
                <div class="vc_row wpb-paddign-top-0 wpb_row vc_row-fluid">
                  <div class="wpb_column vc_column_container vc_col-sm-7">
                    <div class="vc_column-inner">
                      <div class="wpb_wrapper">    
                        ...
                        <?php
                            get_template_part( 'template-parts/content/content', 'catalogs-brochures-flyers' );
                          ?>
                      </div>
                    </div>
                  </div>
                  <div class="wpb_column vc_column_container vc_col-sm-5 wpb-mobile-margin-top-32 ">
                    <div class="vc_column-inner">
                      <div class="wpb_wrapper">
                        <div class="p-form-placeholder">
                          <?php
                            get_template_part( 'template-parts/content/content', 'catalogs-brochures-flyers-form' );
                          ?>  
                        </div>
                      </div>
                    </div>
