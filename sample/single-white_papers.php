...
<div class="content knowledge-center single-white-papers single-post side-block-page">
                  ...
                  <div class="wpb_column vc_column_container vc_col-sm-7">
                    <div class="vc_column-inner">
                      <div class="wpb_wrapper">    
                        ...
                        <?php
                            get_template_part( 'template-parts/content/content', 'white-papers' );
                          ?>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="vc_column-inner">
                      <div class="wpb_wrapper">
                        <div class="p-form-placeholder">
                          <?php
                            get_template_part( 'template-parts/content/content', 'white-papers-form' );
                          ?>  
                        </div>
                      </div>
                    </div>
