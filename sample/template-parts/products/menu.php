...
<div class="side-block">
  <div class="side-block-content products-side-block-wrapper">
    <div class="products-side-block">
      <div class="pm-data">
        <img class="pm-logo" src="<?php print $template_data['fields']['logo']['url'] ?>" srcset="<?php print kama_thumb_src(array('src' =>  $template_data['fields']['logo']['url'],'w' => $template_data['fields']['logo']['width']*2,'h' => $template_data['fields']['logo']['height']*2));?> 2x"/>
