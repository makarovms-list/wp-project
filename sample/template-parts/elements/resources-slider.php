<div id="resources-slider-block" class="resources-slider-block">
  <div class="resources-slider">
    <?php foreach($template_data['fields']['resources_slider']['slides'] as $slide): ?>
      <div class="r-slide">
        <div class="r-slide-content-wrapper <?php print $slide['color_scheme']; ?>" style="<?php if(isset($slide['image']['url'])) print 'background-image: url('.$slide['image']['url'].');'; ?>">
          <div class="content-area">
            <div class="r-slider-nav-container">
              <div data-aos="fade-right" class="r-slider-arrow slider-prev">
                <svg class="i-svg icon-arrow-1"><use xlink:href="#icon-arrow-1"></use></svg>
              </div>
              <div data-aos="fade-left" class="r-slider-arrow slider-next">
                <svg class="i-svg icon-arrow-1"><use xlink:href="#icon-arrow-1"></use></svg>
              </div>
            </div>
