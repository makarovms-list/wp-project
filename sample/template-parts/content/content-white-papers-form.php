...
<form class="ff-form" data-action="<?php print $white_papers_fields['cd_request_url']; ?>" data-result="https://www.petrosoftinc.com/thank-you-for-requesting-document/">
    <fieldset>
        <div class="vc_row wpb_row vc_inner vc_row-fluid">
            <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-12 vc_col-md-12 vc_col-xs-12">
                <div class="vc_column-inner">
                    <div class="wpb_wrapper">
                        <div class="description"><?php print $white_papers_fields['form_title']; ?></div>
                        ...
                        <input type="hidden" id="leadsource" class="leadsource" name="013" value="<?php print $white_papers_fields['leadsource']; ?>">
                        <input type="hidden" id="source" class="source" name="source" value="<?php print $white_papers_fields['gtm-form-name']; ?>">
                        ...
                        <input type="hidden" name="file" class="file" value="<?php print $white_papers_fields['file']['url']; ?>">  
