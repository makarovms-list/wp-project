<?php 
  $toolkits_fields = get_field('toolkits_fields');
    ...
    <div class="p-status">
      <div class="p-data">
        <?php if (isset($term_list[0]->slug)) : ?>
          <div class="p-file"><a href="<?php print '/toolkits?taxonomy=toolkits_category&taxonomy_terms='.$term_list[0]->slug.'&taxonomy_operator=IN'?>"><?php print $term_list[0]->name ?></a> | <?php print $toolkits_fields['file']['subtype']; ?> <?php print petrosoft_convert_bytes_to_specified($toolkits_fields['file']['filesize'],'M'); ?> MB </div>
        <?php endif; ?>  
      </div>
      <div class="p-sharing">
