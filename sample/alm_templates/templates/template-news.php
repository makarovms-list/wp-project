<?php $term_list = wp_get_post_terms(get_the_ID(),'news_category'); ?>
  <div class="wpb_wrapper vc_row wpb_row vc_inner vc_row-fluid news-archive-post archive-post post-<?php print get_the_ID()?>">
