        ...
        <div class="vc_column-inner">
          <div class="wpb_wrapper">
            <div class="post-content">
              <a href="<?php print isset($term_list[0]->slug) ? '/white-papers?taxonomy=white_papers_category&taxonomy_terms='.$term_list[0]->slug.'&taxonomy_operator=IN' : the_permalink(get_the_ID());?>" class="p-type"><?php print isset($term_list[0]->slug) ? $term_list[0]->name : 'WHITEPAPER';?></a>
